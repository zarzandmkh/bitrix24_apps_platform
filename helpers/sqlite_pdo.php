...
{
    public $error = false; //error reporting? (true/false)
    ...
    public function __construct($dsn, $username='', $password='', $driver_options=array())
    {
        try {
            ...
            echo "Error #1873: Error while working with database..." . $e->getMessage();
            exit();
        }
    }
    ...
    {
        if($this->error || !empty($msg)){
            echo $msg;
        }
        else{
            echo "Error #1873: Error while working with database..." ;
        }
